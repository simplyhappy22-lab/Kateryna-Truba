...
8. `i-have-adhd/SKILL.md` — додано правило повних речень і пункт у pre-send check.
   Оригінал стискає відповідь до дії й короткого списку; агент почав обрубувати слова
   й писати телеграфом, поки з речення зникав сенс. Правило лишає форму скіла
   (результат спочатку, один наступний крок, без преамбул) і забороняє ламати синтаксис.
   Те саме речення додано в `.cursor/rules/skills-routing.mdc`, бо агент читає його в кожній відповіді.
