...
Файли скопійовані майже дослівно. Вісім відхилень, потрібні щоб скіли працювали окремо
...
8. `i-have-adhd/SKILL.md` — додано правило не стискати думку до ярлика.
   Оригінал стискає відповідь до дії й короткого списку; агент почав заміняти два
   речення пояснення двома словами, з яких не відновити суть. Правило лишає форму
   скіла (результат спочатку, один наступний крок, без преамбул) і вимагає лишати
   причину, умову або наслідок, без яких фраза порожня. Те саме стоїть
   в `.cursor/rules/skills-routing.mdc`, бо агент читає його в кожній відповіді.
