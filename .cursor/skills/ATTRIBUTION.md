...
Файли скопійовані майже дослівно. Шість відхилень, потрібні щоб скіли працювали окремо
...
5. `i-have-adhd/SKILL.md` — прибрано `disable-model-invocation: true`, щоб скіл застосовувався
   ...
   пам'ятати викликати, не використовується. `description` відповідно переписано з «Invoke
...
6. `ukrainianizer/references/parazyty.md` — **не з оригіналу, написано тут.** Готового скіла
   ...
   про різницю між часткою й паразитом.
