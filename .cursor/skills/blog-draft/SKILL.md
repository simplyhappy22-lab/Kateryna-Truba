---
name: blog-draft
description: Створення чернетки блог-посту з ідей та ресурсів. Використовуй, коли користувачі хочуть написати блог-пост, створити контент з дослідження або підготувати статтю. Проводить через дослідження, мозковий штурм, складання плану та ітеративне написання з контролем версій.
---

## Введення користувача

Візьми тему та вихідні матеріали з запиту користувача в цьому діалозі. Якщо чогось із наведеного нижче бракує — спитай, перш ніж починати.

Ти **ПОВИНЕН** врахувати введення користувача перед продовженням. Користувач має надати:
...
**ВАЖЛИВО**: Якщо користувач запитує оновлення **наявного блог-посту**, пропусти кроки 0-8 і починай безпосередньо з **Кроку 9**. Спочатку прочитай наявний файл (або файли) чернетки, потім продовжуй з процесом ітерації.

## Потік виконання

Виконуй ці кроки послідовно. **Не пропускай кроки та не продовжуй без затвердження користувача, де це зазначено.**
...
2. Поставити уточнювальні запитання:
   - Який головний висновок ти хочеш донести до читачів?
...
1. Створити структурований план, що включає:
   ...
   - Ключова теза A
   - Ключова теза B
   - Докази на підтвердження з [джерела]
...
3. Включити:
   ...
   - Докази на підтвердження та приклади з дослідження
...
6. **Вимоги до цитування**:
   ...
   - Використовуй нумеровані посилання [1], [2] тощо, або іменовані цитати [Назва джерела]
   - Звʼязуй цитати з розділом Список джерел наприкінці
...
- **Зачіпка**: Починай з питання, дивовижного факту або знайомого сценарію
- **Потік**: Кожен абзац має зʼєднуватися з наступним
- **Докази**: Підтверджуй твердження даними з дослідження
- **Цитування**: ЗАВЖДИ цитуй джерела для:
  ...
  - Використовуй інлайн-цитати у форматі: [Назва джерела] або [Автор, Рік]
- **Голос**: Підтримуй послідовний тон протягом усього тексту
- **Довжина**: Дотримуйтесь цільової кількості слів
- **Читабельність**: Використовуй короткі абзаци, маркери де доречно
- **CTA**: Завершуй чітким закликом до дії або питанням, що провокує думки

## Примітки

- Завжди чекай затвердження користувача у зазначених контрольних точках
- Зберігай всі версії чернеток для історії
- Використовуй веб-пошук для актуальної інформації, коли надані URL
- Якщо ресурсів недостатньо, попроси користувача надати більше або запропонуй додаткове дослідження
- Адаптуй тон відповідно до цільової аудиторії (технічна, загальна, бізнес тощо)
